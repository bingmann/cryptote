...
WGeneratePassword::WGeneratePassword(wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long style)
...
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WGeneratePassword::OnButtonOK) not implemented yet"));
}

void WGeneratePassword::OnButtonCancel(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WGeneratePassword::OnButtonCancel) not implemented yet"));
}

void WGeneratePassword::OnButtonClose(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WGeneratePassword::OnButtonClose) not implemented yet"));
}
