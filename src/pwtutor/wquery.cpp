...
WQueryPass::WQueryPass(struct PassEntry& _passentry, wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, long WXUNUSED(style))
    : wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxTHICK_FRAME),
      passentry(_passentry)
{
    // begin wxGlade: WQueryPass::WQueryPass
...
void WQueryPass::set_properties()
{
    // begin wxGlade: WQueryPass::set_properties
...
void WQueryPass::do_layout()
{
    // begin wxGlade: WQueryPass::do_layout
...
BEGIN_EVENT_TABLE(WQueryPass, wxDialog)
    // begin wxGlade: WQueryPass::event_table
    EVT_TEXT_ENTER(myID_PASSTEXT, WQueryPass::OnTextPassEnter)
    EVT_TEXT(myID_PASSTEXT, WQueryPass::OnTextPassChange)
    EVT_BUTTON(wxID_OK, WQueryPass::OnButtonOK)
    EVT_BUTTON(myID_GIVEUP, WQueryPass::OnButtonGiveUp)
    // end wxGlade
END_EVENT_TABLE();

void WQueryPass::OnTextPassEnter(wxCommandEvent& event)
{
    OnButtonOK(event);
}

void WQueryPass::OnTextPassChange(wxCommandEvent& WXUNUSED(event))
{
    textctrlCheck->Clear();
...
void WQueryPass::OnButtonOK(wxCommandEvent& WXUNUSED(event))
{
...
void WQueryPass::OnButtonGiveUp(wxCommandEvent& WXUNUSED(event))
{
    myrevealed++;
    passentry.revealed++;
...
// wxGlade: add WQueryPass event handlers
